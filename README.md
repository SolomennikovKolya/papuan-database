...
**Этап 6** — дженерик-CRUD UI: 16 справочников/тренировок/походов работают
через единый `CrudView` + `EntityDescriptor`. Заглушки остались только
у разделов «Запросы», «SQL-консоль», «Администрирование», «Сервисный режим».
