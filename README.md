...
- [docs/guideline.md](docs/guideline.md) — **путеводитель по проекту с нуля**: что за технологии, как поделён код, в каком порядке читать (начните отсюда, если разбираетесь впервые).
