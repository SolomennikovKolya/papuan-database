...
**Этап 7** — 13 хитрых запросов по варианту: фильтр-форма + результат-таблица
+ экспорт CSV для каждого. Заглушки остались только у «SQL-консоль»,
«Администрирование», «Сервисный режим».
