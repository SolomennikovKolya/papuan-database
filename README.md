...
**Этап 9** — админ-панель: управление пользователями (создать/блокировать/сбросить
пароль/назначить роли), управление ролями (чекбокс-матрица прав), журнал входов
с фильтрами и пагинацией. Заглушка остался только «Сервисный режим».
