...
**Этап 10** — все основные разделы готовы. Сервисный режим: очистка БД
с двойным подтверждением, идемпотентный посев демо-данных, экспорт дампа
через `pg_dump`. Дальше — финальная полировка и README (этап 11).
